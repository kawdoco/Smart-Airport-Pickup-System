...
$('#loading').show();
        $.ajax({
            ...
            data: 'numdays=' + numdays + '&picklocation=' + picklocation + '&pickdate=' + pickdate + '&picktime=' + picktime + '&returndate=' + returndate + '&returntime=' + returntime + '&carname=' + carname + '&refno=' + refno + '&total=' + model_new + '&car1=' + car1,
            dataType: "html",
