...
echo '<li onclick="set_item2(\''.str_replace("'", "\'", ucfirst(strtolower($end))."-".ucfirst(strtolower($route)) ).'\'); set_item12(\''.$id.'\')   ">'.ucfirst(strtolower($end)).'-'.ucfirst(strtolower($route)).'</li>';
