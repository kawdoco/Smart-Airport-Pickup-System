<style>
    ...
    .selectParent2 select{
     width:100%;
        ...
        border: none;
        background: transparent url("http://www.srilankacars.lk/image/icon/down.png") no-repeat 222px center;
    }
    ...
    .selectParent3 select{
       width:100%;
        ...
        padding: 2px 2px 2px 2px;
        border: none;
        background: transparent url("http://www.srilankacars.lk/image/icon/down.png") no-repeat 278px center;
    }
    ...
    .selectParent4 select{
       width:100% !important;
        ...
        padding: 2px 2px 2px 2px;
        border: none;
        /*background: transparent url("http://www.srilankacars.lk/image/icon/down.png") no-repeat 128px center;*/
    }
...
<form action="" method="POST"  name="form5" id="form5" onsubmit="return validateForm33()">
                    ...
                    <div class="form-group row" style="margin-top: 10px;">
                        <div class="col-sm-12">
                            ...
                            <div class="datepicker-wrap ck">
                                <input type="text" id="dpd15" name="pickdate1" class="form-control2 nw1" placeholder="dd/mm/yy" />
                ...
                <div class="col-md-12">
                    ...
                    <div class="form-group row">
                        <div class="col-sm-12">
                            ...
                            <div class="datepicker-wrap ck">
                                <input type="text" id="dpd16" name="returndate1" class="form-control2 nw1" placeholder="dd/mm/yy" />
