...
$('#toggle').click(function () {
    ...
    if ($(this).is(':checked')) {
        ...
        $("#withdriver_form_tomail").on('submit', function (e) {
...
//
            ...
            var carname = $("#carname_driver").val();
            var refno = $("#refno_driver").val();
            var picklocation = $("#picklocation_driver").val();
            var pickdate = $("#pickdate_driver").val();
            var picktime = $("#picktime_driver").val();
            var returndate = $("#returndate_driver").val();
            var returntime = $("#returntime_driver").val();
            var car1 = $("#car1").val();
           
            var total = $("#total_driver").val();
            var numdays = $("#numdays_driver").val();
//alert(numdays+" "+picklocation+" "+ pickdate+" "+ picktime+" "+returndate+ " "+returntime +" carneme "+carname +" refno "+refno+" total "+total+" car1 "+car1);


            $.ajax({
             
                url: "mail_withdriver_carbooking.php", // Url to which the request is send
                type: "POST", // Type of request to be send, called as method
                 data: 'title=' + title + '&fname=' + fname + '&familyname=' + familyname + '&address=' + address + '&country=' + country + '&email=' + email + '&tele=' + tele + '&fax=' + fax + '&nic=' + nic + '&adult=' + adult + '&child=' + child + '&infant=' + infant + '&flightno=' + flightno + '&flighttime=' + flighttime + '&inquire=' + inquire + '&carname=' + carname + '&refno=' + refno + '&picklocation=' + picklocation + '&pickdate=' + pickdate + '&picktime=' + picktime + '&returndate=' + returndate + '&car1=' + car1 + '&returntime=' + returntime + '&6_letters_code=' + code + '&place=' + place +'&total=' +total +'&numdays='+numdays,
               
//                data: 'title=' + title + '&fname=' + fname + '&familyname=' + familyname + '&address=' + address + '&country=' + country + '&email=' + email + '&tele=' + tele + '&fax=' + fax + '&nic=' + nic + '&adult=' + adult + '&child=' + child + '&infant=' + infant + '&flightno=' + flightno + '&flighttime=' + flighttime + '&inquire=' + inquire + '&carname=' + carname + '&refno=' + refno + '&picklocation=' + picklocation + '&pickdate=' + pickdate + '&picktime=' + picktime + '&returndate=' + returndate + '&car1=' + car1 + '&pickup=' + pickup + '&returntime=' + returntime + '&6_letters_code=' + code + '&place=' + place +'&total=' +total +'&numdays='+numdays,
                dataType: "html",
...
<div id="form_submit3">
 <form action="" method="POST" name="driverbookfrm" id="withdriver_form_tomail">     
<input type="hidden" value="<?php echo strtoupper($row['carname']);  ?> " id="carname_driver" name="carname">
<input type="hidden" value="<?php echo strtoupper($row['refno']);  ?> " id="refno_driver" name="refno">   
<input type="hidden" value="<?php echo htmlentities($_POST['picklocation']) ?>" id="picklocation_driver" name="picklocation">
<input type="hidden" value="<?php echo htmlentities($_POST['pickdate']) ?>" id="pickdate_driver" name="pickdate">
<input type="hidden" value="<?php echo htmlentities($_POST['picktime']) ?>" id="picktime_driver" name="picktime">
<input type="hidden" value="<?php echo htmlentities($_POST['returndate']) ?>" id="returndate_driver" name="returndate">
<input type="hidden" value="<?php echo htmlentities($_POST['returntime']) ?>" id="returntime_driver" name="returntime">
<input type="hidden" value="<?php echo htmlentities($_POST['numdays']) ?>" id="numdays_driver" name="numdays">
<input type="hidden" name="car1" value='<?php echo $row['id'] ; ?>' id="car1">
<input type="hidden" value="<?php echo $_POST['total'] ?> " id="total_driver" name="total">       
                    ...
                    <div class="row" style="margin: 10px;">
                        ...
                        <div class="row">
                           ...
                           <div class="form-group" >
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <input type="text" class="form-control2" id="nic3" placeholder="NIC/Passport No" value='<?php echo htmlentities($nic) ?>' name="nic">
                                </div>
                            </div>
                            <br>
...
<div class="col-md-12">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <input type="text" class="form-control2" id="place3" placeholder="Pickup Place" value='<?php echo htmlentities($place) ?>' name="place">
                                </div><br>                            
                            </div>  
                            <div class="col-md-12">
                                <div class="err_captcha3" style="color: red;font-size: 16px;">
...
<!--                             <i class="fa fa-clock-o" aria-hidden="true" style="color:#f3891d; font-size:15px;"></i>-->
 ...
 USD <?php echo $_POST['total'];  ?> </span></h4>
