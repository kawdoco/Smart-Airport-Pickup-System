...
$('#loading').show();
        ...
        $.ajax({
            ...
            data: 'pickup=' + pickup + '&pickoff=' + pickoff + '&pickoff1=' + pickoff1 + '&dateon=' + dateon + '&ontime=' + ontime + '&car1=' + car1 + '&carname=' + carname + '&refno=' + refno + '&totprice='+model_new,
            dataType: "html",
...
<?php echo htmlentities($_POST['pickoff']) ?>
            ...
            <div class="row" style="border-bottom:  #efefef solid 1px; margin-top: 15px;">
                <div class="col-sm-12">
                    ...
                    <h4 class="tourh4">Total Price :  <span style="color: #515657; font-size: 15px;" > 
<?php
$tot=0;
...
?> 
     ...
     <span id="finl_tot"><?php echo $tot;?></span>                       LKR</span></h4>
