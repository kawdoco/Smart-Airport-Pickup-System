...
<form action="" method="POST" name="form4" id="form4" onsubmit="return validateForm6()">
                                        ...
                                        <div class="form-group"  style="margin-top: 20px;">
                                            <label style="margin-bottom: 10px;">Pick Up Location</label>
                                              <div class="selectParent5">
                                                  <select class="form-control2 nw1 location" style="width: 160px; " name="picklocation" id="picklocation" value="">
...
<!--                                        <div class="col-sm-8"  style="margin-top: 20px;">
                                        <div class="form-group" >
                                            <label  style="margin-bottom: 10px;">Return Location</label>
       <input type="text" name="returnlocation" id="returnlocation" class="form-control2 nw1" placeholder="city, distirct or specific airpot"  />
                                    ...
                                    <input type="text" id="dpd11" name="pickdate" class="form-control2 nw2" placeholder="dd/mm/yy" />
                                     ...
                                     <div class="form-group row">
                                            <div class="col-sm-6">
                                                <div class="datepicker-wrap ck">
                                    <input type="text" id="dpd12" name="returndate" class="form-control2 nw2" placeholder="dd/mm/yy" />
