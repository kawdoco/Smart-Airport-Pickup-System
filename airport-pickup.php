...
<script>
    $(document).ready(function () {
        ...
        $("#pickup_form_tomail").on('submit', function (e) {
...
//                 
        ...
        var tt1=$("#model_n").val();
         ...
         $('input[name="round_tour"]').click(function () {
                    if ($(this).prop("checked") === true) {
                        
                        if($('#baby_seat').is(':checked') ){
                            $("#finl_tot").text("");
                            
                        var price3=$("#model").val()-500;
                        var price4=$("#model_n").val();
//                        alert(price);
                        var price1=price4 - price4*(20/100);
                        var tot=Number(price3)+Number(price1)+500;
                        $("#model").val(tot);
                        $("#finl_tot").text(tot);
                         ...
                         $("#finl_tot").text("");
                        var price=$("#model_n").val();
                        var price2=$("#model").val();
//                        alert(price);
                        var price1=price - price*(20/100);
                       
                        var tot=Number(price2)+Number(price1);
                        $("#model").val(tot);
                        $("#finl_tot").text(tot);
//                        alert($("#finl_tot").val());
                        }
                        ...
                        $("#finl_tot").text("");
                         tot=Number($("#model").val())-Number(tt1- tt1*20/100);
                        $("#finl_tot").text(tot);
                        $("#model").val(tot);
                    }
                });
         ...
         $('input[name="baby_seat"]').click(function () {
                    if ($(this).prop("checked") === true) {
                         $("#finl_tot").text("");
                        var price=$("#model").val();
//                        alert(price);
                        
                        var tot=Number(price)+500;
...
<div id="form_submit1">
    <form action="" method="POST" name="pickupfrm" id="pickup_form_tomail">    
        ...
        <input type="hidden" value="<?php echo htmlentities($_POST['pickup']) ?>" id="pickup50" name="pickup">
        <input type="hidden" value="<?php echo htmlentities($_POST['pickoff']) ?>" id="pickoff50" name="pickoff">
...
?>' id="model_n"> 
        ...
        if($_POST['totprice'] !="" || $_POST['totprice']!=null){
...
if (isset($row['dispickup']) && ( $row['dispickup'] != '0')) {
        ...
        <div class="col-md-12">
                ...
                <div class="row" style="margin: 0; padding: 0; background-color: #FFF;">
                    ...
                    <div class="row" style="margin: 10px;">
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="col-md-12">
                                <div class="err_captcha" style="color: red;font-size: 16px;">
            ...
            <div class="col-sm-3" >
                ...
                <div class="row" style=" background-color: #FFF;  margin-left: 0; padding: 20px;">
                    ...
                    <div class="row">
                        <div class="col-sm-4">
                            <img src="./home/mahinda/photos/<?php echo $row['img1']; ?> " width="100" class="img-responsive"/></div>
                        <div class="col-sm-8">
    ...
    <!--                                        <?php //echo $_POST['pickoff1'];    ?><br>-->
                    ...
                    <div class="row">
                        <div class="col-md-12">
                        Round Tour <input type="checkbox" id="round_tour" name="round_tour">
                        </div>
                        <div class="col-md-12">
                        Baby Seat <input type="checkbox" id="baby_seat" name="baby_seat">
                        </div>
                    </div>
                    <div class="row" style="border-bottom:  #efefef solid 1px; margin-top: 15px;">
                        <div class="col-sm-12">   <h4 class="tourh4">Total Price :  <span style="color: red; font-size: 18px;" > 
                                    <?php
//    echo $row1[trim($row['model'])];  
                                    $tot=0;
                                    ...
                                    if (isset($row['dispickup']) && ( $row['dispickup'] != '0')) {
                                        echo "<strike>" . $row1[$row['model']] . "</strike>";
                                        echo " - " . $row['dispickup'] . "% <br/>";
//                                        echo "<br/> " . ($row1[$row['model']] - (($row1[$row['model']]) * ($row['dispickup'] / 100)));
                                        $tot=($row1[$row['model']] - (($row1[$row['model']]) * ($row['dispickup'] / 100)));
                                    } else {
//                                        echo $row1[$row['model']];
                                        $tot= $row1[$row['model']];
                                    }
