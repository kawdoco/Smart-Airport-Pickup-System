...
<html lang="en-US">
    <head>
        <title>About - Ayubowan Cabs</title>
...
<!-- End Facebook Pixel Code -->
    ...
    <body style="background:url('img/2.jpg');background-attachment: fixed;">
     


        <?php require_once('menu.php'); ?>
        <div class="container-edit-fluid" style="margin-top: 150px;">
            <div class="curve"><a href="#about"><img src="img/down.png" alt="Down" class="center-block"></a></div>
        </div>
        <div class="container-edit-fluid" style="background-color: #e5e5e5;" id="about">


          <div class="container-edit"  style="padding: 80px;">
                
                <div class="row">
                    <h1 class="text-center" style="font-size: 80px;color:#f58220;font-weight: 900;letter-spacing: -1px; "><span style="font-weight: 100;letter-spacing: -1px;">Who</span> Are We</h1>
                    <p class="text-center" style="font-size: 18px;">
                        A subsidiary of Ayubowan Tours, a well established destination Management Company in Sri Lanka, operating for the past decade from Sri Lanka, holding its branches in European countries as well, sets forth the foundation to a timely venture which involves the expertise of handling clientele from all sorts of nationalities, ensuring a hassle free service at all times.<br>
                        <br>Focusing on the potential in the tourism industry of Sri Lanka, the Chairman looks at a systematical approach in the services segment, where the client is always secure in his end, since the fleet of vehicles are all linked and managed through the backbone, a team of experts in the trade of fleet management and customer service.
                    </p>
                </div>
