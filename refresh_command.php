...
echo '<li onclick="set_item20(\''.str_replace("'", "\'", ucfirst(strtolower($end))."-".ucfirst(strtolower($route)) ).'\'); set_item21(\''.$id.'\')   ">'.ucfirst(strtolower($end)).'-'.ucfirst(strtolower($route)).'</li>';
