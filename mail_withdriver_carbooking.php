<?php
//
$your_email = 'asantha@ayubowantours.com, mahinda@ayubowantours.com, info@ayubowantours.com';// <<=== update to your email address
...
//$total='';
	...
	if(empty($errors))
	{
		...
		$to1 = $email;
                ...
                $subject1 = "Car With Driver Booking -  Thank You For Your Inquiry  " . date("Y-m-d h:i:sa");
		$from = $email;
...
<tr>
		...
		$headers .= "Reply-To: $email \r\n";
                ...
                $headers .= "Content-type:text/html;charset=UTF-8" . "\r\n";
                 ...
                 $headers1 = "From: $your_email \r\n";
		$headers1 .= "Reply-To: $your_email \r\n";
    ...
    mail($to1, $subject1, $body, $headers1);
