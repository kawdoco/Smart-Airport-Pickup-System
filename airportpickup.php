            ...
            <div class="row" style="background-color: #f5f5f5; position: relative; ">
                                    <div class="col-sm-6" style="margin-top: 20px;margin-bottom:40px;  " >
                                        ...
                                        <div class="form-group"  style="margin-top: 20px;">
                                            ...
                                            <!--<input type="text" name="pickup" id="pickup" placeholder="Air Port" value="Air Port" class="form-control2 nw1" readonly>-->
                                            <input type="text" name="pickup" id="pickup10" placeholder="Air Port" value="Air Port" class="form-control2 nw1" readonly="">
<!--                                            <input type="text" name="pickup"  class="form-control1 nw1" placeholder="city, distirct or specific airpot" />-->
       ...
       <input type="text" name="pickoff" id="pickoff" class="form-control2 nw1" placeholder="city, distirct or specific airpot" onkeyup="autocomplet1()"  onclick="(this.value = '')" />
       <input type="hidden" name="pickoff1" id="pickoff1" />
                                    ...
                                    <input type="text" id="dpd3" name="dateon" class="form-control2 nw2" placeholder="dd/mm/yy" />
