...
$('#toggle').click(function () {
    ...
    if ($(this).is(':checked')) {
        ...
        $("#rentcar_form_tomail").on('submit', function (e) {
...
//
            ...
            var inquire = $("#inquire").val();
             ...
             var licensexpdate = $("#licensexpdate").val();
             var licensissuedate = $("#licensissuedate").val();
            
          var carname = $("#carname1").val();
            var refno = $("#refno1").val();
            var picklocation = $("#picklocation_rent").val();
            var pickdate = $("#pickdate1").val();
            var picktime = $("#picktime_rent").val();
            var returndate = $("#returndate1").val();
            var returntime = $("#returntime_rent").val();
            var car1 = $("#car1").val();
           
            var total = $("#total1").val();
            var numofdays = $("#numofdays_rent").val();

//alert(numofdays+" "+picklocation+" "+ " "+ picktime+" "+ " "+returntime );
          
            $.ajax({
                url: "mail_rent_carbooking.php", // Url to which the request is send
                type: "POST", // Type of request to be send, called as method
                data: 'title=' + title + '&fname=' + fname + '&familyname=' + familyname + '&address=' + address + '&country=' + country + '&email=' + email + '&tele=' + tele + '&fax=' + fax + '&nic=' + nic + '&adult=' + adult + '&child=' + child + '&infant=' + infant + '&flightno=' + flightno + '&flighttime=' + flighttime + '&inquire=' + inquire + '&carname=' + carname + '&refno=' + refno + '&picklocation1=' + picklocation + '&pickdate1=' + pickdate + '&picktime1=' + picktime + '&returndate1=' + returndate + '&car1=' + car1 + '&licenseno=' + licenseno + '&returntime1=' + returntime + '&6_letters_code=' + code + '&place=' + place +'&total=' +total +'&numofdays='+numofdays+'&licensexpdate='+licensexpdate+'&licensissuedate='+licensissuedate,
                dataType: "html",
...
//                 
 ...
 <div id="form_submit4">
     <form action="" method="POST" name="rentcarbookfrm" id="rentcar_form_tomail">
  
    
 <input type="hidden" value="<?php echo strtoupper($row['carname']);  ?> " id="carname1" name="carname">
 <input type="hidden" value="<?php echo strtoupper($row['refno']);  ?> " id="refno1" name="refno">   
 <input type="hidden" value="<?php echo htmlentities($_POST['picklocation1']) ?>" id="picklocation_rent" name="picklocation1">
<input type="hidden" value="<?php echo htmlentities($_POST['pickdate1']) ?>" id="pickdate1" name="pickdate1">
<input type="hidden" value="<?php echo htmlentities($_POST['picktime1']) ?>" id="picktime_rent" name="picktime1">
<input type="hidden" value="<?php echo htmlentities($_POST['returndate1']) ?>" id="returndate1" name="returndate1">
<input type="hidden" value="<?php echo htmlentities($_POST['returntime1']) ?>" id="returntime_rent" name="returntime1">
<input type="hidden" value="<?php echo htmlentities($_POST['numofdays']) ?>" id="numofdays_rent" name="numofdays">


<input type="hidden" name="car1" value='<?php echo $row['id'] ; ?>' id="car1">  

<input type="hidden" value="<?php echo $_POST['total'] ?> " id="total1" name="total">   
                ...
                <hr style=" border-color: #d0ebf6; ">
                    ...
                    <div class="row" style="margin: 10px;">
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="col-md-12">
                                <div class="form-group" >
                                    <input type="text" class="form-control2" id="licenseno" placeholder="License No" value='<?php echo htmlentities($licenseno) ?>' name="licenseno">
                                </div>            
                            </div> 
                            <br>   
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <input type="text" class="form-control2" id="nic" placeholder="NIC/Passport No" value='<?php echo htmlentities($nic) ?>' name="nic">
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
                                    <input type="date" class="form-control2" id="licensexpdate" placeholder="License Expiry Date" value='<?php echo htmlentities($licensexpdate) ?>' name="licensexpdate">
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
                                    <input type="date" class="form-control2" id="licensissuedate" placeholder="License Issue Date" value='<?php echo htmlentities($licensissuedate) ?>' name="licensissuedate">
                                </div>
                            </div>
                            <br>
                    ...
                    <div class="row" style="margin: 10px;">
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <input type="text" class="form-control2" id="place" placeholder="Pickup Place" value='<?php echo htmlentities($place) ?>' name="place">
                                </div><br>                            
                            </div>  
                            <div class="col-md-12">
                                <div class="err_captcha4" style="color: red;font-size: 16px;">
...
<!--                         <p > 
                 <button class="btn btn-default btn-md btn-group-justified bb" style="max-width: 70px;" action="action" type="button"  value="Back" onclick="history.go(-1);" >Back</button>                
                   ...
                   <div class="row" >
                      ...
                      <div class="row" style="border-bottom:  #efefef solid 1px; margin-bottom: 10px;">
                         <div class="col-sm-2">
...
<!--                             <i class="fa fa-clock-o" aria-hidden="true" style="color:#f3891d; font-size:15px;"></i>-->
                             ...
                             <i class="fa fa-pencil-square-o" aria-hidden="true" style="color:#f3891d; font-size:15px;"></i>
